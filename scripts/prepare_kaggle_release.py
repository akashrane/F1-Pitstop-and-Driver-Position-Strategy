...
def prepare_release(data_root: Path, start_year: int, end_year: int, destination: Path, slug: str, title: str) -> None:
...
def main() -> int:
    ...
    parser.add_argument("--title", default="F1 Pit Stop, Stint, Weather and Race Results")
    args = parser.parse_args()
    prepare_release(args.data_root, args.start_year, args.end_year, args.destination, args.slug, args.title)
    return 0
